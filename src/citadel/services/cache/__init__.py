...
RamCache is a byte-budgeted, thread-safe LRU (OrderedDict). The cache daemon
(tools/ram_cache_daemon.py) holds hot artifacts in RAM and serves them over a local
unix socket; CacheClient is the thin client with disk fallback. This is what lets
